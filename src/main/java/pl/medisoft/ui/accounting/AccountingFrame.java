 ...
 */
package pl.medisoft.ui.accounting;
 ...
 */
public class AccountingFrame extends BaseFrame {
    
    private final Messages messages = Messages.getInstace();
    private final String MODULE_NAME = messages.get(ModuleEnum.ACCOUNTING.getMessageKey());
    
    public AccountingFrame(final JFrame parent) {
        super(parent);
